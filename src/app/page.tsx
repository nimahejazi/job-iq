      ...
      <div className="grid gap-6 lg:grid-cols-[1.35fr_0.65fr]">
        <section className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                This placeholder shell gives future onboarding screens a stable
                visual direction.
              </CardDescription>
            </CardHeader>
        ...
        <aside className="space-y-6">
          ...
          <EmptyState
            ...
            description="Resume parsing, job ingestion, and scoring will plug into this UI foundation next."
